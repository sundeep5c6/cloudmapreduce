 ...
 */
public class CloudMapReduceIntTest extends MapReduceApp {
	
	private static Logger appLogger = Logger.getLogger("com.acnlabs.CloudMapReduce.CloudMapReduceIntTest");
